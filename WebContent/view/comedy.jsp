				...
				<!-- /movie-browse-agile -->
				      ...
				      <div class="movie-browse-agile">
						...
						<div class="browse-agile-w3ls general-w3ls">
							...
							<c:forEach var="i" begin="0" end="${indexcomedy}">
							   <div class="col-md-2 w3l-movie-gride-agile">
										 <a href="joinsingle" class="hvr-shutter-out-horizontal"><img src="view/images/${listcomedy[i].poster}" title="album-name" alt=" " />
									     <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
									</a>
									  <div class="mid-1">
										<div class="w3l-movie-text">
										<form action="joinsingle" method="post">
								<input name="id" type="hidden" value="${listcomedy[i].id}">
									<button style="width:100%; height:20px; padding: 0;border: none;background: none;"><p style="color:orange;text-decoration: none;">View</p></button>
											...
											<h6><a >${listcomedy[i].title}</a></h6>							
										</div>
										<div class="mid-2">
										
											<p>${listcomedy[i].year}</p>
											<div class="block-stars">
												<ul class="w3l-ratings">
													     ${listcomedy[i].view} Views
