			...
			<div class="container">
				...
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">A - Z</a></li>
							<li role="presentation" ><a href="#a" role="tab" id="a-tab" data-toggle="tab" aria-controls="a">Z - A</a></li>
						...
						<div id="myTabContent" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
								<div class="agile-news-table">
									<div class="w3ls-news-result">
										<h4>Search Results : <span>${indexlist}</span></h4>
									</div>
									<table id="table-breakpoint">
										...
										<c:forEach var="i" begin="0" end="${indexsize }">
										  <tr>
											...
											<td class="w3-list-img"><a ><img src="view/images/${listaz[i].poster}" alt="" />
											<form action="joinsingle" method="post">
											<input name="id" type="hidden" value="${listaz[i].id}">
									<button style=" height:20px; padding: 30;border: none;background: none;"><p style="color:orange;text-decoration: none;">View</p></button>
								</form>
											 <span>${listaz[i].title}</span></a></td>
											<td>${listaz[i].year}</td>
											
											
											<td class="w3-list-info"><a >${listaz[i].genre}</a></td>
											<td>${listaz[i].view}</td>
										  </tr>
										  </c:forEach>
							...
							<div role="tabpanel" class="tab-pane fade " id="a" aria-labelledby="home-tab">
								<div class="agile-news-table">
									<div class="w3ls-news-result">
										<h4>Search Results : <span>${indexlist}</span></h4>
									</div>
									<table id="table-breakpoint1">
										...
										<c:forEach var="i" begin="0" end="${indexsize}">
										  <tr>
											...
											<td class="w3-list-img"><a ><img src="view/images/${listza[i].poster}" alt="" />
											<form action="joinsingle" method="post">
											<input name="id" type="hidden" value="${listza[i].id}">
										<button style=" height:20px; padding: 30;border: none;background: none;"><p style="color:orange;text-decoration: none;">View</p></button>
									</form>
											 <span>${listza[i].title}</span></a></td>
											<td>${listza[i].year}</td>
											
											
											<td class="w3-list-info"><a >${listza[i].genre}</a></td>
											<td>${listza[i].view}</td>
										  </tr>
										  </c:forEach>
