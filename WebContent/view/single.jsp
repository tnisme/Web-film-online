				...
				<div class="col-sm-8 single-left">
					...
					<div class="song-grid-right">
						<div class="share">
							...
							<form method="post">
								<input  name="idvideo" type="hidden" value="${single[0].id }">
									<input name="userid" type="hidden" value="${userid}" >
									<button formaction="like" style="width:10%; height:20px; padding: 0;border: none;background: none;"><p style="color:orange;text-decoration: none;">Like</p></button>
									<button  formaction="share" style="width:10%; height:20px; padding: 0;border: none;background: none;"><p style="color:orange;text-decoration: none;">Share</p></button>								
								</form>
					...
					<div class="single-grid-right">
						...
						<div class="single-right-grids">
							<div class="col-md-4 single-right-grid-left">
								...
								<a ><img src="view/images/${listnext[i].poster }" alt="" /></a>
							</div>
							<div class="col-md-8 single-right-grid-right">
							<form action="joinsingle" method="post">
								<input name="id" type="hidden" value="${listnext[i].id}">
								...
								<a  class="title"> ${listnext[i].title }</a>
								<p class="author"><a href="#" class="author">${listnext[i].year }</a></p>
								<p class="views">${listnext[i].view } views</p>
							</div>
