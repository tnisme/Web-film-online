				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="series.jsp">tv - series</a></li>
			...
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				...
				<div id="myTabContent" class="tab-content">
					<div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
						...
						<c:forEach var="i" begin="0" end="11">
							<div class="col-md-2 w3l-movie-gride-agile">
								<a href="view/single.jsp" class="hvr-shutter-out-horizontal"><img src="view/images/${listfeatured[i].poster}" title="album-name" class="img-responsive" alt=" " />
								...
								<input name="id" type="hidden" value="${listfeatured[i].id}">
									<button style="width:10%; height:20px; padding: 0;border: none;background: none;"><p style="color:orange;text-decoration: none;">View</p></button>
								</form>
										<h6><a href="view/single.jsp">${listfeatured[i].title}</a></h6>							
									</div>
					...
					<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
						<c:forEach var="i" begin="0" end="11">
						<div class="col-md-2 w3l-movie-gride-agile">
							<a href="view/single.jsp" class="hvr-shutter-out-horizontal"><img src="view/images/${listtopviews[i].poster}" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
								...
								<input name="id" type="hidden" value="${listtopviews[i].id}">
									...
									<h6><a href="view/single.jsp">${listtopviews[i].title}</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
					...
					<div role="tabpanel" class="tab-pane fade" id="imdb" aria-labelledby="imdb-tab">
						<c:forEach var="i" begin="0" end="11">
						<div class="col-md-2 w3l-movie-gride-agile">
							<a href="view/single.jsp" class="hvr-shutter-out-horizontal"><img src="view/images/${listrecently[i].poster}" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								<div class="w3l-movie-text">
								...
								<input name="id" type="hidden" value="${listrecently[i].id}">
									...
									<h6><a href="view/single.jsp">${listrecently[i].title}</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
				...
				<div class="w3_agile_banner_bottom_grid">
					...
					<div class="item">
						<div class="w3l-movie-gride-agile w3l-movie-gride-agile1">
							...
							<a href="view/single.jsp" class="hvr-shutter-out-horizontal"><img src="view/images/${listreview[i].poster}" title="album-name" class="img-responsive" alt=" " />
								<div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
							</a>
							...
							<div class="mid-1 agileits_w3layouts_mid_1_home">
								...
								<input name="id" type="hidden" value="${listreview[i].id}">
									...
									<h6><a href="view/single.jsp">${listreview[i].title}</a></h6>							
								</div>
								<div class="mid-2 agile_mid_2_home">
