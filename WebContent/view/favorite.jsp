				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav>
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="favorite">Favorite</a></li>
						</ul>
					</nav>
				</div>
			</nav>	
...
<!-- faq-banner -->
	<div class="faq">
		<h4 class="latest-text w3_faq_latest_text w3_latest_text">Favorite</h4>
			<div class="container">
							...
							<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
								<div class="agile-news-table">
									...
									<table id="table-breakpoint">
										...
										<c:forEach var="i" begin="0" end="${indexfavorite }">
										  <tr>
											
											<td class="w3-list-img"><a ><img src="view/images/${listfavorite[i].poster}" alt="" />
											<form action="joinsingle" method="post">
											<input name="id" type="hidden" value="${listfavorite[i].id}">
											
									<button style=" height:20px; padding: 30;border: none;background: none;"><p style="color:orange;text-decoration: none;">View</p></button>
								</form>
											 <span>${listfavorite[i].title}</span></a></td>
											<td>${listfavorite[i].year}</td>
											
											
											<td class="w3-list-info"><a >${listfavorite[i].genre}</a></td>
											<td>${listfavorite[i].view}</td>
										  </tr>
										  </c:forEach>
